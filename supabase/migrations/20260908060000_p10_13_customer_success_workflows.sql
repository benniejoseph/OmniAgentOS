...
BEGIN
  IF (
    ...
    WHERE version = 140
      AND name = 'customer_health_scoring_v1'
      AND checksum = '91f12ad0fdae25496f14bf21751491470f4572bcb58c587360373dc038b063e2'
  ) <> 1 THEN
    RAISE EXCEPTION 'Customer-success workflow predecessor is invalid'
      USING ERRCODE = '55000';
  END IF;
END
$migration$;
...
VALUES (
  141,
  'customer_success_workflows_v1',
  '6ed4f5625107af151e49cf1fe094b9637af2053f5f1c85e31f6984cc1b4e7f38',
  clock_timestamp()
);
