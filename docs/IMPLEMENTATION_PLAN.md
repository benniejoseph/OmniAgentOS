...
> P3.1 status after item 57: an authenticated direct run can compile only the
> canonical user's explicitly selected private-memory evidence, under an exact
