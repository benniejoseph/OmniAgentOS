...
Migration 177 and the matching web/worker revision were deployed on 2026-09-16. The production canary completed a governed replay over an existing 480-bar XAU/USD 15-minute snapshot, sealed 28 trades including eight in the held-out test slice, and revalidated immutable-snapshot and next-bar-entry leakage checks. The Backtest lab rendered the same sealed result without overflow at wide and phone browser widths.
