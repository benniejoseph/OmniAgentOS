...
**Status:** Stage 0 foundation plus Stage 2 provider access, immutable price snapshots, FRED history, and official BLS schedule enrichment implemented; transcript ontology, observed-value vintages, non-BLS exact timestamps, impact windows, detectors, replay, calibration, and forward-shadow execution remain pending
