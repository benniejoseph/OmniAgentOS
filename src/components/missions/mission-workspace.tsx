...
export function talkHref(mission: MissionSummaryView) { const prompt = "Continue this mission. Review its durable task board, advance only ready work within governed authority, preserve evidence, and surface blockers."; return `/app/command?mission=${encodeURIComponent(mission.id)}&context=mission&prompt=${encodeURIComponent(prompt)}`; }
