...
type BuilderReadinessEvidence = Readonly<{ mode: "deterministic"; version: 1; phase: "checkpoint" | "preview" | "release"; status: "pending" | "passed" | "failed"; summary: string; signals: ReadonlyArray<{ name: "lint" | "typecheck" | "build_logs" | "route_smokes"; status: "pending" | "passed" | "failed" }> }>;
type BuilderBrowserEvidence = Readonly<{ status: "pending" | "captured" | "unavailable" | "failed" | "retired"; captures: ReadonlyArray<{ viewport: "desktop" | "mobile"; width: number; height: number; screenshotSha256: string; mimeType: string; byteLength: number }>; errorCode?: string; legacyField?: true; summary?: string; replacement?: BuilderReadinessEvidence }>;
type BuilderVerification = Readonly<{ id: string; sessionId: string; checkpointId: string; workspaceSha256: string; status: "passed" | "failed" | "incomplete"; checks: ReadonlyArray<{ command: "lint" | "typecheck"; status: "passed" | "failed"; exitCode: number; durationMs: number; outputSha256: string }>; browserEvidence: BuilderBrowserEvidence; createdAt: string }>;
