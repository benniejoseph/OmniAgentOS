...
import type { MissionOwner } from "@/lib/missions/store";

export function missionMutationFromRequest(
  request: Request,
  context: SecurityContext,
  input: { purpose: string; missionId?: string; causationId?: string },
): Pick<MissionOwner, "executionScope" | "idempotencyKey"> {
