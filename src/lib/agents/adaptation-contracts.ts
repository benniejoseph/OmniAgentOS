...
export const agentAdaptationEvidenceV1Schema = z.object({
  evidenceId: idSchema,
  kind: z.enum(["run_feedback", "project_artifact"]),
  sourceId: idSchema,
...
export const agentAdaptationV1Schema = z.object({
  ...
  if (
    ...
    sourceContractSha256({
      ...
      guidance: value.effect.guidance,
      guidanceSha256: value.effect.guidanceSha256,
      authorityImpact: value.effect.authorityImpact,
    }) !== value.effect.effectSha256 ||
