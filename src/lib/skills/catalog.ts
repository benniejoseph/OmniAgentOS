...
export const builtInSkills: AgentSkill[] = [
  ...
  },
  {
    ...
    category: "analysis", status: "active", version: 1, toolIds: ["knowledge.search", "runs.list", "app.projects.builder.show", "app.projects.builder.tree", "app.projects.builder.search", "app.projects.builder.file.read", "app.projects.builder.verification.show"], tags: ["review", "safety"], knowledgeTags: [], builtIn: true, createdAt, updatedAt: createdAt,
  },
  {
