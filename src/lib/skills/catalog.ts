...
export const builtInSkills: AgentSkill[] = [
  ...
  },
  {
    ...
    category: "creation", status: "active", version: 1, toolIds: ["web.search", "knowledge.search", "app.projects.builder.show", "app.projects.builder.create", "app.projects.builder.tree", "app.projects.builder.file.read", "app.projects.builder.file.update", "app.projects.builder.command.run", "app.projects.builder.checkpoint.create", "app.projects.builder.repositories.list", "app.projects.builder.repository.bind", "app.projects.builder.delivery.create", "app.projects.builder.deployment.preview", "app.projects.builder.deployment.refresh", "app.projects.builder.release.preview", "app.projects.builder.release.refresh"], tags: ["build", "verify", "deliver"], knowledgeTags: [], builtIn: true, createdAt, updatedAt: createdAt,
  },
  {
