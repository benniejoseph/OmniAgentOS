...
export async function executeFirstPartyAppTool(input: {
  ...
  const handlers: Record<string, () => Promise<unknown>> = {
    ...
    "app.market_research.backtests.list": () => listMarketBacktestsService(caller, input.toolInput as never),
    "app.market_research.backtests.run": () => runMarketBacktestService(caller, input.toolInput as never),
    ...
    "app.projects.builder.release.preview": () => previewProjectBuilderProductionReleaseService(caller, input.toolInput as never),
    "app.projects.builder.release.production": () => releaseProjectBuilderProductionService(caller, input.toolInput as never),
    "app.projects.builder.release.refresh": () => refreshProjectBuilderProductionReleaseService(caller, input.toolInput as never),
    ...
    "app.workflows.schedules.list": () => listWorkflowSchedulesService(caller, input.toolInput as never),
    "app.workflows.schedules.preview": () => previewWorkflowScheduleService(caller, input.toolInput as never),
    "app.workflows.schedules.create": () => createWorkflowScheduleService(caller, input.toolInput as never),
    "app.workflows.schedules.control": () => controlWorkflowScheduleService(caller, input.toolInput as never),
